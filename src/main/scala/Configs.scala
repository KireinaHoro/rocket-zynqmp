...
object EdgeBoardParams extends Params {
  ...
  override val RAMSize = 0x40000000L // 1 GiB
  override val MMIOBase = 0xe0000000L // ZynqMP Peripherals
  val NInterrupts = 3 // UART, Ethernet, Ethernet Wake
...
abstract class Params {
  ...
  val BootROMBase: Int = 0x20000
  val BootROMSize: Int = 0x20000
  val BootROMHang: Int = 0x20000
  val SystemFreq: Long
  val NInterrupts: Int
